...
public class ScrapperControllerWithExceptionHandlerTest {
    ...
    public void deleteChatTest_serviceException()  {
        long chatId = 1L;
        doThrow(new ScrapperUserNotExistsException("message")).when(scrapperService).deleteUser(chatId);
    ...
    public void getLinksTest_serviceException_userNotFound()  {
        long chatId = 1L;
        doThrow(new ScrapperUserNotExistsException("message")).when(scrapperService).getUserLinks(chatId);
