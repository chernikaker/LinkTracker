...
public class SchedulerTest {
    ...
    public void checkNewUpdates_noLinkUpdates() {
        when(linkService.getLinksToCheck(anyInt(), anyLong(), anyLong())).thenReturn(Map.of());
    ...
    public void checkNewUpdates_manyLinksUpdates() {
        ...
        UpdateInfo updateInfo2 = new UpdateInfo(
                "New answer", "description", "Author", linkUpdateTime2.plusDays(1), UpdateInfoType.ANSWER);
    ...
    public void checkNewUpdates_manyLinksOneUpdateOnlyOneSent() {
        ...
        UpdateInfo updateInfo1 = new UpdateInfo(
                "New pr", "description", "Author", linkUpdateTime1.plusDays(1), UpdateInfoType.PULL_REQUEST);
        UpdateInfo updateInfo2 = new UpdateInfo(
                "New answer", "description", "Author", linkUpdateTime2.minusDays(1), UpdateInfoType.ANSWER);
